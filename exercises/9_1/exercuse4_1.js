 ...
 * Logo, adicione na função sendMarsTemperature um callback que contenha
...
const sendMarsTemperature = callback => setTimeout(_=> callback(getMarsTemperature()), messageDelay());
